  ...
  <div class="register">
    <section class="form_container">
      <div class="manage_tip">
        <span class="title">Fone后台管理系统</span>
        <el-form :model="registerUser" status-icon :rules="rules" ref="registerForm" label-width="80px" class="registerForm">
          ...
          <el-form-item label="身 份" filterable prop="identity">
    ...
    return {
      ...
      rules: {
        name: [
          ...
          {min:3, max:20, message: "用户名长度必须在3-20", trigger: 'blur'}
        ],
        email: [
        ...
        password: [
          ...
          {min:6, max:30, message: "密码长度必须在6-30", trigger: 'blur'}
        ],
        password2: [
          {required: true, message: "确认密码不能为空", trigger: 'blur'},
          {min:6, max:30, message: "确认密码长度必须在6-30", trigger: 'blur'},
